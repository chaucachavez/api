...
{   
    ...
    public $titulo = 'FIRMAS DE ATENCIÓN';
...
class firmasdeatencionController extends Controller 
{    
    ...
    public function reporte(Request $request, $enterprise, $id)
    {
        ...
        $paramDx = array('citamedica.idcicloatencion' => $id, 'diagnosticomedico.idgrupodx' => $request['idgrupodx']);
        $paramEfect = array('cicloatencion.idcicloatencion' => $id, 'terapia.idestado' => 38, 'terapiatratamiento.idgrupodx' => $request['idgrupodx']); 
        ...
        $user = $objEntidad->entidad(['entidad.identidad' => $this->objTtoken->my]);
        ...
        $pdf->SetTextColor(19, 138, 114); 
        $pdf->SetDrawColor(19, 138, 114); 
        ...
        $grupo = grupodx::find($request['idgrupodx']);
